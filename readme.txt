...
This is a project that can be opened both in eclipse and intellij
...
(2)Click on Practice Mode button ------> Name Selection Screen
The Name Selection Screen would contain:
		a search two name button -----> opens a dialog that asks two names
		a load txt file button ------> load the correct txt file would add concadenated name to list
...
*********************
(1)Double click on the application ----> Main Menu
(2)First Select Practise names - the database will automatically load 
...
The Name Selection Screen would contain:
										...
										a next button -----> to enter the next stage of practsing
										a back button -----> in case the initialisation of names go off, back to step (2)
(4)You can either add single names or enter a first and last name
	*To enter a first and last name click the search button at the bottom of the screen. Enter ONE name in the first name box and ONE name in the last name box.
	 Note we are still in the beta phase sp cannot do multiple names so only enter one name otherwise you will get an error
(5) Click Next ----> Takes you to practise mode
	*Double click on name on left to see the multiple recordings.
>>>>>>> 22d1cb928790a7554aa0ff9a3d7c00f43e4fdb55
...
*********************
<<<<<<< HEAD
After selected a name in the selected name list. Click on the new button followed by the record button. After a short duration the recording will be produced and can be seen in the new recording section.
